...
```json
{
  "compilerOptions": {
    ...
    /* 언어와 환경 */
    "target": "es2016" /* 출력될 JavaScript의 버전과 호환되는 라이브러리 선언을 설정합니다. */,
    ...
    // "emitDecoratorMetadata": true,                    /* 소스 파일의 데코레이터가 적용된 선언에 대한 디자인-타입 메타데이터를 출력합니다. */
    ...
    // "noUncheckedSideEffectImports": true,             /* 부작용이 있는 가져오기를 검사합니다. */
    ...
    // "inlineSourceMap": true,                          /* 출력된 JavaScript 안에 소스맵 파일을 포함합니다. */
    // "noEmit": true,                                   /* 컴파일에서 파일 출력을 비활성화합니다. */
    // "outFile": "./",                                  /* 모든 출력을 하나의 JavaScript 파일로 번들링하는 파일을 지정합니다. 'declaration'이 true이면 .d.ts 출력도 번들링하는 파일도 지정합니다. */
    ...
    // "newLine": "crlf",                                /* 파일 출력 시 사용할 줄바꿈 문자를 설정합니다. */
    ...
    // "strictBuiltinIteratorReturn": true,              /* 내장 반복자는 'any' 대신 'undefined'로 'TReturn' 타입이 인스턴스화됩니다. */
    ...
    // "alwaysStrict": true,                             /* 항상 'use strict'가 출력되도록 보장합니다. */
    // "noUnusedLocals": true,                           /* 읽히지 않은 지역 변수에 대한 오류 보고를 활성화합니다. */
